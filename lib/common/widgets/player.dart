...
// import '../utils/player_ui_utils.dart';
...
//   static const bottomOffsetClosed = 50.0;
...
//     final audioPlayer = Get.find<AudioService>();
...
//                                 Expanded(
//                                   child: StreamBuilder(
//                                     stream: audioPlayer.mediaItemStream,
...
//                                   stream: audioPlayer.playbackStateStream,
//                                   builder: (context, playbackSnapshot) {
//                                     final playerState = playbackSnapshot.data;
//                                     final playing =
...
//                                             create: (_) =>
//                                                 audioPlayer.mediaItemStream,
//                                             initialData: null,
//                                           ),
//                                         ],
//                                         builder: (context, child) =>
//                                             Consumer2<Duration, MediaItem?>(
//                                               builder: (context, position, mediaItem, child) {
//                                                 if (playing) {
...
//                                 stream: audioPlayer.mediaItemStream,
//                                 builder: (context, snapshot) => TrackInfo(
...
//                               builder: (context, snapshot) {
//                                 final double y =
//                                     -(pow(progressValue - 1, 2)).toDouble() + 2;
//                                 return TrackImage(
//                                   image: Container(
//                                     color: Theme.of(
//                                       context,
...
//                           providers: [
//                             StreamProvider<Duration>(
//                               create: (_) => audioPlayer.positionStream,
//                               initialData: Duration.zero,
//                             ),
//                             StreamProvider<MediaItem?>(
//                               create: (_) => audioPlayer.mediaItemStream,
//                               initialData: null,
//                             ),
//                           ],
//                           builder: (context, child) =>
